...
class FiletotextPage extends StatelessWidget {
  const FiletotextPage({super.key});
...
class _TranscriptionScreenState extends State<TranscriptionScreen> {
  ...
  // Add these to your _TranscriptionScreenState class
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;
  final FirebaseAuth _auth = FirebaseAuth.instance;

// Modify _saveEditedText to save to Firestore
  void _saveEditedText() async {
    ...
    try {
      await _firestore.collection('users').doc(user.uid).collection('transcriptions').add({
        'title': _audioFile?.path.split('/').last ?? 'Transcription',
        'text': text,
        'words': wordCount,
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Text saved successfully to your history')),
      );
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
